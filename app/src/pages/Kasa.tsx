...
export default function Kasa({
      ...
      >
        <div
          style={{
            ...
            boxShadow: "0 24px 64px rgba(28,18,9,0.08)",
          }}
        >
          <div
            style={{
          ...
          >
            Twoje zamówienie zostało przyjęte do realizacji. Na podany adres
            email ({form.email}) przesłaliśmy potwierdzenie oraz szczegóły.
          </p>
          <button
            onClick={() => navigate("/")}
  ...
  return (
    <div
      style={{ minHeight: "100vh", background: "#FAF7F2", paddingBottom: 100 }}
    >
      {/* Header */}
      <header
        style={{
          ...
          >
              ...
              {["blik", "karta", "przelew"].map((m) => (
                <label
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    gap: 12,
                    background: form.payment === m ? "#5C8A9E08" : "#fff",
                    transition: "all .2s",
                  }}
                >
                  <input
            ...
            <button
              ...
              style={{
                ...
                padding: "16px",
                borderRadius: 30,
                background: cart.length === 0 ? "#D0C4B8" : "#1C1209",
                color: "#FAF7F2",
                border: "none",
        ...
        >
          ...
          {cart.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div
                style={{ borderTop: "1px solid #E8DDD0", margin: "12px 0" }}
              />
