...
export default function ChatBot({ accent = "#5C8A9E" }: { accent?: string }) {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      id: 1,
      text: "Cześć! Jestem wirtualnym asystentem AromaBrew ☕ W czym mogę pomóc?",
      sender: "bot",
    },
  ]);
  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const botMsg: Msg = {
        id: Date.now(),
        text: "Przekazałem Twoje pytanie do naszego zespołu. Odpowiemy najszybciej jak to możliwe! 🍃",
        sender: "bot",
      };
