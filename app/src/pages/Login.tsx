...
const USER_API =
  (import.meta.env.VITE_USER_API as string) || "http://localhost:8001/api/v1";
...
const IHome = (p: any) => (
  <Ic {...p} d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2zM9 22V12h6v10" />
);
const ICal = (p: any) => (
  <Ic
    {...p}
...
const CoffeeCup = ({ flipped = false }) => (
  ...
  >
    ...
    />
    <path
      d="M76 47 Q98 49 98 63 Q98 77 76 73"
      fill="none"
      stroke="#DEB880"
      strokeWidth="5"
      strokeLinecap="round"
    />
    <path
      d="M76 47 Q94 49 94 63 Q94 75 76 73"
      fill="none"
    ...
    />
    <path
      d="M32 29 Q28 20 32 11"
      fill="none"
      stroke="#C8B898"
      strokeWidth="2"
      strokeLinecap="round"
      style={{
        animation: "steam-a 1.9s ease-in-out infinite",
        animationDelay: "0s",
      }}
    />
    <path
      d="M45 27 Q41 18 45 9"
      fill="none"
      stroke="#C8B898"
      strokeWidth="2"
      strokeLinecap="round"
      style={{
        animation: "steam-b 1.9s ease-in-out infinite",
        animationDelay: ".45s",
      }}
    />
    <path
      d="M58 29 Q54 20 58 11"
      fill="none"
      stroke="#C8B898"
      strokeWidth="2"
      strokeLinecap="round"
      style={{
        animation: "steam-c 1.9s ease-in-out infinite",
        animationDelay: ".2s",
      }}
    />
  </svg>
...
const ElegantTeapot = ({ flipped = false }: { flipped?: boolean }) => (
  ...
  >
    ...
    {/* decorative band */}
    <path
      d="M40 90 Q84 97 128 90"
      stroke="#E0B030"
      strokeWidth="3.5"
      fill="none"
    />
    <path
      d="M42 82 Q84 89 126 82"
      stroke="#E0B030"
      strokeWidth="1.2"
      fill="none"
      opacity=".45"
    ...
    {/* ornate dot border */}
    <path
      d="M40 90 Q84 97 128 90 Q128 96 84 99 Q40 96 40 90Z"
      fill="#C49020"
      opacity=".25"
    />
    {/* sheen */}
    ...
    <ellipse
      ...
      transform="rotate(-22,78,64)"
    />
    {/* spout – elegant 2-curve shape */}
    <path
      d="M127 79 Q150 62 155 44"
      stroke="#6A3808"
      strokeWidth="12"
      strokeLinecap="round"
      fill="none"
    ...
    <path
      d="M40 72 Q12 72 12 88 Q12 104 40 98"
      stroke="#6A3808"
      strokeWidth="10"
      strokeLinecap="round"
      fill="none"
    />
    <path
      d="M40 72 Q16 72 16 88 Q16 102 40 98"
      stroke="#D4A030"
      strokeWidth="5.5"
      strokeLinecap="round"
      fill="none"
    />
    <path
      d="M40 72 Q18 72 18 88 Q18 100 40 98"
      stroke="rgba(255,255,255,.1)"
      strokeWidth="2.5"
      strokeLinecap="round"
      fill="none"
...
const TeaGlass = ({ animDur = SCENE_MS }) => {
  ...
  return (
    ...
    >
      ...
      {/* glass body outline */}
      <path
        d="M10 26 L6 158 L78 158 L74 26 Z"
        fill="rgba(210,240,230,.04)"
        stroke="rgba(210,240,230,.55)"
        strokeWidth="1.5"
      />
      {/* vertical ribs */}
      {[0, 1, 2, 3, 4, 5].map((i) => (
      ...
      {[95, 112, 130, 148].map((y, i) => (
        <path
          key={`h${i}`}
          d={`M${11 + i * 0.5} ${y} Q42 ${y - 4} ${73 - i * 0.5} ${y}`}
          stroke="rgba(210,240,230,.13)"
          strokeWidth="1"
          fill="none"
        />
      ))}
      ...
      {[0, 1, 2, 3, 4].map((col) =>
        [95, 112, 130].map((row, ri) => (
          <rect
            ...
            width="3"
            height="3"
            fill="rgba(210,240,230,.2)"
            transform={`rotate(45 ${15.5 + col * 11} ${row})`}
          />
        )),
      )}
      {/* tea fill */}
      <g clipPath="url(#glassClip2)">
        <rect
          ...
          fill="url(#teaFillG)"
          style={{
            transformOrigin: "42px 160px",
            animation: `tea-fill-rise ${s} ease forwards`,
          }}
        />
      </g>
      ...
      <ellipse
        ...
        rx="33"
        ry="8.5"
        fill="rgba(210,240,230,.06)"
        stroke="rgba(210,240,230,.6)"
        strokeWidth="1.5"
      />
      {/* bottom */}
      <ellipse
        ...
        rx="37"
        ry="6"
        fill="rgba(210,240,230,.05)"
        stroke="rgba(210,240,230,.28)"
        strokeWidth="1"
      />
      {/* steam after pour */}
      <path
        d="M30 18 Q26 5 30 -7"
        stroke="rgba(210,190,140,.6)"
        strokeWidth="1.8"
        fill="none"
        strokeLinecap="round"
        style={{ animation: `glass-steam-a ${s} ease forwards` }}
      />
      <path
        d="M42 16 Q38 3 42 -9"
        stroke="rgba(210,190,140,.5)"
        strokeWidth="1.8"
        fill="none"
        strokeLinecap="round"
        style={{ animation: `glass-steam-b ${s} ease forwards` }}
      />
      <path
        d="M54 18 Q50 4 54 -8"
        stroke="rgba(210,190,140,.55)"
        strokeWidth="1.8"
        fill="none"
        strokeLinecap="round"
        style={{ animation: `glass-steam-c ${s} ease forwards` }}
      />
    </svg>
  );
};
    ...
    <div style={{ position: "relative", width: 290, height: 195 }}>
      ...
      <div
        style={{
          ...
          left: 8,
          top: 25,
          animation: `pour-scene-fade ${s} ease forwards`,
        }}
      >
...
const IcedCup = ({ flipped = false, animDur = SCENE_MS }) => {
  ...
  return (
    ...
    >
      ...
      {/* glass wall – outer */}
      <path
        d="M2 16 L12 128 L60 128 L70 16 Z"
        fill={`url(#glassWallG${flipped ? "R" : "L"})`}
        stroke="rgba(210,235,245,.52)"
        strokeWidth="1.5"
      />
      {/* glass wall inner edge (thickness effect) */}
      <path
        d="M5 18 L14 127 L58 127 L67 18 Z"
        fill="none"
        stroke="rgba(210,235,245,.12)"
        strokeWidth="1"
      />
      ...
      <g
        style={{
          animation: `ice-shake-b ${s} ease forwards`,
          transform: "rotate(10deg)",
          transformOrigin: "46px 56px",
        }}
      >
        <rect
          x="36"
      ...
      <g
        style={{
          animation: `ice-shake-c ${s} ease forwards`,
      ...
      {/* === DOME LID === */}
      <path
        d="M1 16 C 1 -8, 71 -8, 71 16"
        fill="rgba(210,235,245,.15)"
        stroke="rgba(210,235,245,.4)"
        strokeWidth="1.5"
      />
      <path
        d="M10 5 C 20 -5, 52 -5, 62 5"
        fill="none"
      ...
      <ellipse
        ...
        rx="34"
        ry="7"
        fill="rgba(210,235,245,.07)"
        stroke="rgba(210,235,245,.58)"
        strokeWidth="1.5"
      />
      <ellipse
        cx="36"
      ...
      <ellipse
        ...
        rx="24"
        ry="5"
        fill="rgba(210,235,245,.06)"
        stroke="rgba(210,235,245,.28)"
        strokeWidth="1"
      />
    </svg>
  );
...
const Spark = ({ color = "#FFF8E8", animDur = SCENE_MS }) => (
  <svg
    ...
    height="60"
    style={{
      animation: `impact-pop ${animDur}ms ease forwards`,
      position: "absolute",
      pointerEvents: "none",
    }}
  >
    {[0, 45, 90, 135, 180, 225, 270, 315].map((a, i) => (
      <line
        ...
        x1="30"
        y1="30"
        x2={30 + 20 * Math.cos((a * Math.PI) / 180)}
        y2={30 + 20 * Math.sin((a * Math.PI) / 180)}
        stroke={color}
...
const SCENES = [
  {
    id: "coffee",
    label: "Kawa Espresso",
    hint: "Filiżanki single origin",
    spark: "#F0DEB0",
  },
  { id: "pour", label: "Herbata Premium", hint: "Ceremonia nalewania" },
  {
    id: "iced",
    label: "Americano z lodem",
    hint: "Cold brew w szklance",
    spark: "#A8D8EE",
  },
];
...
const AnimPanel = () => {
  ...
  const dur = SCENE_MS;
  const aL = {
    animation: `obj-left ${dur}ms cubic-bezier(.22,1,.36,1) forwards`,
  };
  const aR = {
    animation: `obj-right ${dur}ms cubic-bezier(.22,1,.36,1) forwards`,
  };
  ...
  return (
    <div
      style={{
        position: "relative",
        background: "linear-gradient(155deg,#190E04,#0D0905)",
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div
          key={`lbl-${animKey}`}
          style={{
            animation: `label-show ${dur}ms ease forwards`,
            marginBottom: 20,
            textAlign: "center",
          }}
        >
          ...
          {scene === 1 ? (
            ...
            <>
              ...
              <div
                key={`l-${animKey}`}
                style={
                  { ...aL, display: "flex", alignItems: "flex-end" } as any
                }
              >
              ...
              <div
                key={`r-${animKey}`}
                style={
                  { ...aR, display: "flex", alignItems: "flex-end" } as any
                }
              >
                {scene === 0 && <CoffeeCup />}
                {scene === 2 && <IcedCup />}
          ...
          {SCENES.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: 4,
                borderRadius: 4,
                background: i === scene ? ACCENT : "rgba(255,255,255,.14)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          type={isP ? (sp ? "text" : "password") : type}
          value={value}
          ...
          style={{
            ...
            paddingRight: isP ? 42 : 14,
            border: `1.5px solid ${error ? "#C04040" : "#2C1C0C"}`,
            borderRadius: 11,
            fontFamily: "DM Sans",
            fontSize: 14,
            color: "#FAF7F2",
        ...
        {isP && (
          ...
          >
            {sp ? (
              <IEyeOff size={16} stroke="#9E7A5A" />
            ) : (
              <IEye size={16} stroke="#9E7A5A" />
            )}
          </button>
        )}
      </div>
...
const StepDots = ({ total, cur }: { total: number; cur: number }) => (
  <div
    style={{ display: "flex", gap: 7, alignItems: "center", marginBottom: 28 }}
  >
    {Array.from({ length: total }).map((_, i) => (
      <div
        ...
        style={{
          ...
          width: i === cur ? 26 : 14,
          borderRadius: 4,
          background: i === cur ? ACCENT : i < cur ? `${ACCENT}55` : "#2C1C0C",
          transition: "all .3s",
        }}
      />
    ))}
  ...
  return (
    ...
    >
      <Field
        ...
        error={err.email}
        icon={<IMail size={15} stroke="#9E7A5A" />}
      />
      <Field
        label="Hasło"
        type="password"
      ...
      <button
        ...
        style={{
          ...
          background: loading ? "#2C1C0C" : ACCENT,
          color: loading ? "#5A4030" : "#fff",
          fontFamily: "DM Sans",
          fontSize: 14,
          fontWeight: 500,
          marginTop: 2,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ flex: 1, height: 1, background: "#2C1C0C" }} />
        <span style={{ fontFamily: "DM Sans", fontSize: 11, color: "#4A3A2A" }}>
          lub
        </span>
        <div style={{ flex: 1, height: 1, background: "#2C1C0C" }} />
      </div>
...
const STEPS = [
  { t: "Dane konta", s: "Stwórz dane logowania" },
  { t: "Dane osobowe", s: "Kilka słów o Tobie" },
  { t: "Adres dostawy", s: "Gdzie wysyłamy zamówienia?" },
];
...
const RegisterForm = ({ onSwitch }: any) => {
  ...
  const validate = () => {
    const e: any = {};
    if (step === 0) {
      if (!f.email.includes("@")) e.email = "Podaj poprawny email";
      if (f.pass.length < 6) e.pass = "Min. 6 znaków";
      if (f.pass !== f.passC) e.passC = "Hasła nie są zgodne";
    }
    if (step === 1) {
      if (!f.name.trim()) e.name = "Podaj imię i nazwisko";
      const a = parseInt(f.age);
      if (!f.age || a < 13 || a > 120) e.age = "Wiek: 13–120";
    }
    if (step === 2) {
      if (!f.city.trim()) e.city = "Wymagane";
      if (!f.street.trim()) e.street = "Wymagane";
      if (!f.houseNo.trim()) e.houseNo = "Wymagane";
      if (!/^\d{2}-\d{3}$/.test(f.postal)) e.postal = "Format: XX-XXX";
    }
    return e;
  };
  const next = (e: any) => {
  ...
  if (done)
    return (
      <div style={{ textAlign: "center", padding: "28px 0" }}>
        ...
        >
          Witamy,{" "}
          <strong style={{ color: "#FAF7F2" }}>{f.name.split(" ")[0]}</strong>!
        </p>
        <p
          style={{
            fontFamily: "DM Sans",
        ...
        >
          Link aktywacyjny wysłany na {f.email}
        </p>
        <Link
          to="/"
          style={{
        ...
        {step === 0 && (
          <>
            ...
            <Field
              ...
              error={err.pass}
              hint="Użyj liter, cyfr i znaków specjalnych"
            />
            <Field
        ...
        {step === 1 && (
          <>
            <Field
              ...
              error={err.name}
              icon={<IUser size={15} stroke="#9E7A5A" />}
            />
            <Field
              label="Wiek"
              type="number"
              ...
              min={13}
              max={120}
              icon={<ICal size={15} stroke="#9E7A5A" />}
            />
          </>
        )}
        {step === 2 && (
          <>
            <Field
              ...
              error={err.city}
              icon={<IMap size={15} stroke="#9E7A5A" />}
            />
            <Field
              label="Ulica"
              value={f.street}
              ...
              error={err.street}
              icon={<IHome size={15} stroke="#9E7A5A" />}
            />
            <div
              style={{
                display: "grid",
            ...
            >
              <Field
                label="Nr domu / mieszk."
                value={f.houseNo}
                onChange={upd("houseNo")}
                placeholder="12A / 3"
                error={err.houseNo}
              />
              <Field
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 20 }}>
        {step > 0 && (
          <button
            ...
            onMouseLeave={(e) =>
              (e.currentTarget.style.borderColor = "#2C1C0C")
            }
          >
            <IArrowL size={14} stroke="#7A6A5A" />
          </button>
        )}
        <button
          type="submit"
        ...
        >
          {step < STEPS.length - 1 ? "Dalej →" : "Utwórz konto"}
        </button>
      </div>
      <p
        style={{
...
export default function Login() {
  ...
  const titles: any = {
    login: ["Zaloguj się", "Dostęp do konta i historii zamówień."],
    register: [STEPS[0].t, STEPS[0].s],
  };
  return (
      ...
      >
        ...
        >
          ...
          <div style={{ maxWidth: 410, width: "100%", margin: "0 auto" }}>
            ...
            >
              {mode === "login" ? (
                <LoginForm onSwitch={() => sw("register")} />
              ) : (
                <RegisterForm onSwitch={() => sw("login")} />
              )}
            </div>
          </div>
          <p
