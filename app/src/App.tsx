...
const MEGA: Record<string, { label: string; sub: string; id: string }[]> = {
  Kawy: [
    {
      label: "Kawa Ziarnista",
      sub: "Single origin & blends",
      id: "kawa-ziarnista",
    },
    {
      label: "Kawa Mielona",
      sub: "Do ekspresu przelewowego",
      id: "kawa-mielona",
    },
    ...
    {
      label: "Rozpuszczalna",
      sub: "Szybka i wygodna",
      id: "kawa-rozpuszczalna",
    },
  ],
  Herbaty: [
    {
      label: "Herbata Zielona",
      sub: "Japońska & chińska",
      id: "herbata-zielona",
    },
    {
      label: "Herbata Czarna",
      sub: "Assam, Darjeeling, Ceylon",
      id: "herbata-czarna",
    },
    { label: "Herbata Biała", sub: "Delikatna, kwiatowa", id: "herbata-biala" },
    { label: "Oolong", sub: "Częściowo utleniona", id: "herbata-oolong" },
    {
      label: "Ziołowe Napary",
      sub: "Rumianek, mięta, imbir",
      id: "herbata-ziolowa",
    },
  ...
  "Dodatki i Syropy": [
    {
      label: "Syropy Smakowe",
      sub: "Lawenda, wanilia, malina",
      id: "dodatki-syropy",
    },
    {
      label: "Mleko Roślinne",
      sub: "Owsiane, migdałowe, sojowe",
      id: "dodatki-mleka",
    },
    {
      label: "Słodziki",
      sub: "Miód, cukier trzcinowy",
      id: "dodatki-slodziki",
    },
    {
      label: "Przyprawy",
      sub: "Cynamon, kardamon, imbir",
      id: "dodatki-przyprawy",
    },
  ],
};
...
const MegaIcon = ({
  ...
  switch (id) {
    ...
    case "herbata-oolong":
      return (
        <svg {...s}>
          <path d="M12 3c-1.5 3-4 5-4 9a4 4 0 008 0c0-4-2.5-6-4-9z" />
          <path d="M12 16v5" />
        </svg>
      );
    case "herbata-ziolowa":
      return (
        <svg {...s}>
          <path d="M6 20c3-3 4.5-7 4.5-12" />
          <path d="M18 20c-3-3-4.5-7-4.5-12" />
          <path d="M12 8c-2 0-5 1-6.5 3" />
          <path d="M12 8c2 0 5 1 6.5 3" />
    ...
    case "dodatki-mleka":
      return (
        <svg {...s}>
          <path d="M8 2h8v4c0 1-1 2-2 2h-4c-1 0-2-1-2-2V2z" />
          <path d="M6 8h12v12a2 2 0 01-2 2H8a2 2 0 01-2-2V8z" />
          <path d="M10 13c0-1 1-2 2-2s2 1 2 2-1 2-2 3-2 2-2 3" />
        </svg>
      );
    case "dodatki-slodziki":
      return (
        <svg {...s}>
          <path d="M12 2C8 2 4 5 4 9c0 3 2 5 4 6l1 7h6l1-7c2-1 4-3 4-6 0-4-4-7-8-7z" />
          <path d="M10 14h4" />
        </svg>
      );
    case "dodatki-przyprawy":
      return (
        <svg {...s}>
...
const BACKEND_FILTER: Record<
  string,
  { kategoria?: string; podkategoria?: string }
> = {
  all: {},
  kawa: { kategoria: "Kawa" },
...
const PRODUCTS: Product[] = [
  {
    ...
    subtitle: "Kawa ziarnista single origin",
    tags: ["100% Arabica", "Single Origin", "Owocowy"],
    price: 89,
    weight: "250g",
    rating: 4.8,
    reviews: 124,
    color: "#8B6642",
    desc: "Delikatna, kwiatowa z nutami czarnej porzeczki i bergamotki.",
  ...
  },
  {
    ...
    category: "espresso",
    name: "Roma Classico",
    subtitle: "Kawa do espresso blend",
    tags: ["Arabica & Robusta", "Intensywny", "Ciemny Palnik"],
    price: 72,
    weight: "250g",
    rating: 4.6,
    reviews: 87,
    color: "#5C3520",
    desc: "Klasyczne włoskie espresso — głęboka gorzkość, kremowa pianka.",
    image: "/images/prod2.jpg",
  },
  {
    id: 3,
    category: "zielona",
    name: "Sencha Kyoto Premium",
    subtitle: "Herbata zielona japońska",
    tags: ["Japan", "Umami", "Wiosenny Zbiór"],
    price: 64,
    weight: "100g",
    rating: 4.9,
    reviews: 203,
    color: "#6B8C6B",
    desc: "Świeża, trawiasta z delikatną słodyczą i charakterystycznym umami.",
  ...
  },
  {
    ...
    subtitle: "Herbata czarna górska",
    tags: ["India", "First Flush", "Muskatelowy"],
    price: 78,
    weight: "100g",
    rating: 4.7,
    reviews: 156,
    color: "#A0522D",
    desc: "Szlachetna, z nutami muscatel i świeżego siana.",
  ...
  },
  {
    ...
    subtitle: "Matcha ceremonial Uji",
    tags: ["Uji Japan", "Ceremonial", "L-Teanina"],
    price: 112,
    weight: "30g",
    rating: 5.0,
    reviews: 89,
    color: "#4A7A4A",
    desc: "Jedwabista, intensywnie zielona, bez goryczy.",
  ...
  },
  {
    ...
    subtitle: "Syrop do kawy i herbaty",
    tags: ["Naturalny", "Prowansja", "Bez GMO"],
    price: 34,
    weight: "250ml",
    rating: 4.5,
    reviews: 61,
    color: "#8E7AB5",
    desc: "Delikatny kwiatowy aromat — idealny do flat white i herbat.",
    image: "/images/prod6.jpg",
  },
  {
    id: 7,
    category: "ziarnista",
    name: "Rwanda Bourbon Reserve",
    subtitle: "Kawa ziarnista specialty",
    tags: ["100% Arabica", "Specialty", "Czerwone Owoce"],
    price: 95,
    weight: "250g",
    rating: 4.8,
    reviews: 42,
    color: "#9E4A2A",
    desc: "Soczysta, winna — maliny i hibiskus w każdym łyku.",
  ...
  },
  {
    ...
    subtitle: "Herbata czarna z bergamotką",
    tags: ["Ceylon", "Bergamotka", "Klasyk"],
    price: 48,
    weight: "100g",
    rating: 4.6,
    reviews: 178,
    color: "#6B5B8A",
    desc: "Elegancki, cytrusowy aromat bergamotki na cejlońskiej bazie.",
  ...
  },
  {
    ...
    subtitle: "Kawa ziarnista premium",
    tags: ["100% Arabica", "Supremo", "Czekoladowy"],
    price: 79,
    weight: "250g",
    rating: 4.7,
    reviews: 93,
    color: "#6B4C3B",
    desc: "Bogata, pełna ciała z nutami ciemnej czekolady i karmelu.",
    image: "/images/prod1.jpg",
  },
  {
    id: 10,
    category: "espresso",
    name: "Napoli Intenso",
    subtitle: "Kawa do espresso premium",
    tags: ["Arabica & Robusta", "Extra Intenso", "Włoski"],
    price: 68,
    weight: "250g",
    rating: 4.5,
    reviews: 112,
    color: "#3C2415",
    desc: "Potężny, gęsty body z długim finiszem i nutami kakao.",
    image: "/images/prod2.jpg",
  },
  {
    id: 11,
    ...
    subtitle: "Herbata zielona chińska",
    tags: ["China", "Pan Fired", "Orzechowy"],
    price: 82,
    weight: "100g",
    rating: 4.8,
    reviews: 67,
    color: "#7A9A5A",
    desc: "Słynna herbata z Hangzhou — orzechowy smak i aksamitna tekstura.",
    image: "/images/prod3.jpg",
  },
  {
    id: 12,
    ...
    subtitle: "Kawa do cold brew",
    tags: ["Cold Brew", "Smooth", "Niskie Kwasy"],
    price: 58,
    weight: "250g",
    rating: 4.6,
    reviews: 145,
    color: "#4A6741",
    desc: "Specjalny blend do parzenia na zimno — słodki, gładki, orzeźwiający.",
    image: "/images/prod7.jpg",
  },
];
...
const STEPS = [
  {
    num: "01",
    title: "Wybierz",
    desc: "Przeglądaj naszą kolekcję ponad 240 odmian kawy i herbaty. Użyj filtrów aby znaleźć swój idealny smak.",
    icon: (color: string) => <ICoffee size={42} stroke={color} />,
  },
  {
    num: "02",
    title: "Zamów",
    desc: "Dodaj produkty do koszyka i sfinalizuj zamówienie w 2 minuty. Darmowa dostawa od 150 zł.",
    icon: (color: string) => <ICart size={42} stroke={color} sw={1.2} />,
  },
  {
    num: "03",
    title: "Delektuj się",
    desc: "Odbierz paczkę w 24h i ciesz się świeżo paloną kawą oraz aromatyczną herbatą.",
    icon: (color: string) => <ISparkles size={42} stroke={color} />,
  },
];
...
const ISearch = (p: any) => (
  <Ic {...p} d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z" />
);
const ICart = (p: any) => (
  <Ic
    {...p}
...
const TRUST_ITEMS = [
  {
    icon: <ITruck size={28} stroke="#C4882A" />,
    title: "Darmowa dostawa",
    desc: "Od 150 zł",
  },
  {
    icon: <IReturn size={28} stroke="#C4882A" />,
    title: "30 dni na zwrot",
    desc: "Bez podawania przyczyny",
  },
  {
    icon: <IZap size={28} stroke="#C4882A" />,
    title: "Wysyłka 24h",
    desc: "Ekspresowa dostawa",
  },
  {
    icon: <ILeaf size={28} stroke="#C4882A" />,
    title: "100% naturalne",
    desc: "Certyfikowane źródła",
  },
  {
    icon: <ILock size={28} stroke="#C4882A" />,
    title: "Bezpieczna płatność",
    desc: "SSL & szyfrowanie",
  },
];
...
const Stars = ({ rating }: { rating: number }) => (
  <div style={{ display: "flex", gap: 2 }}>
    {[1, 2, 3, 4, 5].map((i) => (
      <IStar key={i} filled={i <= Math.round(rating)} size={12} />
    ))}
  </div>
);
  ...
  return (
    <div
      style={{
        ...
        borderTop:
          open && section ? "1px solid #E8DDD0" : "1px solid transparent",
        boxShadow: open && section ? "0 16px 48px rgba(28,18,9,0.09)" : "none",
      }}
    >
      <div
        style={{ maxWidth: 1280, margin: "0 auto", padding: "36px 48px 40px" }}
      >
        <p
          style={{
        ...
        >
          {items.map((it) => (
            ...
            >
              ...
              >
                <MegaIcon id={it.id} color={accent} size={18} />
              </div>
              <p
                style={{
                  fontFamily: "'DM Sans',sans-serif",
...
export const Navbar = ({
  ...
  const API =
    (import.meta.env.VITE_PRODUCTS_API as string) ||
          ...
          >
            ...
            >
              {navSections.map((s) => (
                <button
                  key={s}
                  className={`nav-link${megaOpen === s ? " active" : ""}`}
                  ...
                  style={{
                    ...
                    fontFamily: "'DM Sans',sans-serif",
                    fontSize: 14,
                    fontWeight: megaOpen === s ? 500 : 400,
                    color: megaOpen === s ? accent : "#5C3D1E",
                    letterSpacing: ".02em",
                    transition: "color .2s",
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  <IChevDown
                    size={12}
                    stroke={megaOpen === s ? accent : "#9E7A5A"}
                  />
                </button>
              ))}
            </div>
              ...
              <div ref={searchRef} style={{ position: "relative" }}>
                <div
                  style={{
                    ...
                    alignItems: "center",
                    gap: 8,
                    background: searchOpen ? "#F2EBE0" : "transparent",
                    borderRadius: 24,
                    padding: searchOpen ? "6px 14px" : "6px",
                    transition: "all .3s ease",
                  }}
                >
                  {searchOpen && (
                    <input
                      data-testid="search-input-field" // <-- DODANE DLA TESTÓW
                      autoFocus
                      value={searchQuery}
                      onChange={(e) => {
                        ...
                        if (el && e.target.value.trim().length >= 2)
                  ...
                  <button
                    data-testid="search-toggle-btn" // <-- DODANE DLA TESTÓW
                    onClick={() => {
                  ...
                  >
                    {searchOpen ? (
                      <IX size={17} stroke="#5C3D1E" />
                    ) : (
                      <ISearch size={17} stroke="#5C3D1E" />
                    )}
                  </button>
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {searchLoading
                          ? "Wyszukiwanie..."
                          : `Znaleziono ${searchResults.length} ${searchResults.length === 1 ? "produkt" : searchResults.length < 5 ? "produkty" : "produktów"}`}
                      </p>
                    </div>
                    ...
                    <div style={{ maxHeight: 320, overflowY: "auto" }}>
                      {searchResults.map((product, i) => {
                        ...
                        return (
                          <button
                            data-testid="search-result-item" // <--- DODAJ TĘ LINIĘ TUTAJ
                            key={product.id}
                            className="fade-up"
                            onClick={() => {
                              setShowResults(false);
                            ...
                            onMouseEnter={(e) =>
                              (e.currentTarget.style.background = "#F2EBE0")
                            }
                            onMouseLeave={(e) =>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              >
                                ...
                                {product.podkategoria && (
                                  <>
                                    <span
                                      style={{ color: "#D0C4B8", fontSize: 10 }}
                                    >
                                      ·
                                    </span>
                                    <span
...
const useAuth = () => {
  ...
  const logout = () => {
    ["access_token", "id_token", "refresh_token", "user_email"].forEach((k) =>
...
const AuthControl = ({
  ...
  const items: { label: string; onClick?: () => void; icon: any }[] = [
    ...
    {
      label: "Koszyk",
      icon: <ICart size={15} stroke="#5C3D1E" />,
      onClick: () => {
        setOpen(false);
        onCartClick();
      },
      ...
      {open && (
        <div
          style={{
            ...
            border: "1px solid #E8DDD0",
            borderRadius: 14,
            boxShadow: "0 12px 32px rgba(28,18,9,.12)",
            padding: 8,
            zIndex: 200,
          }}
        >
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "-20px 0 60px rgba(28,18,9,0.12)",
        }}
      >
        <div
          style={{
            ...
            <>
              ...
              {hasMore && !expanded && (
                <button
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = "#D0C4B8";
                    e.currentTarget.style.color = "#9E7A5A";
                  }}
                >
        ...
        {cart.length > 0 && (
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => (e.currentTarget.style.background = accent)}
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "#1C1209")
              }
            >
              Przejdź do kasy
            </button>
        ...
        return (
          <button
            ...
            style={{
              padding: "9px 20px",
              borderRadius: 30,
              border: on ? "none" : "1.5px solid #E8DDD0",
              ...
              cursor: "pointer",
              boxShadow: on ? `0 4px 14px ${accent}38` : "none",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                padding: "9px 18px",
                borderRadius: 22,
                background: added ? "#6B8C6B" : accent,
                color: "#fff",
                border: "none",
                cursor: "pointer",
                fontFamily: "'DM Sans',sans-serif",
                ...
                fontWeight: 400,
                transition: "all .3s ease",
                boxShadow: `0 4px 14px ${added ? "#6B8C6B" : accent}38`,
              }}
            >
              {added ? (
                <>
                  <ICheck size={13} stroke="#fff" /> Dodano
                </>
              ) : (
                "+ Koszyk"
              )}
...
const ICoffeeBean = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    style={{ transform: `rotate(${angle}deg)`, opacity: 0.3 }}
  >
  ...
  >
    <div
      style={{
        position: "absolute",
        inset: 0,
        background: `linear-gradient(135deg, #FAF7F2 0%, ${accent}0A 100%)`,
      }}
    />
    ...
    >
      <div style={{ transform: "rotate(30deg)", opacity: 0.3 }}>
        <ILeaf size={64} stroke={accent} />
      </div>
    </div>
    <div
      className="float-anim"
    ...
    >
      <div style={{ transform: "rotate(-25deg)", opacity: 0.3 }}>
        <ILeaf size={50} stroke={accent} />
      </div>
    </div>
    <div
      className="float-anim"
  ...
  >
    ...
    <div
      ...
      style={{
        ...
        borderRadius: 24,
        overflow: "hidden",
        boxShadow: "0 28px 72px rgba(28,18,9,0.15)",
      }}
    >
      <img
        src="/images/hero.jpg"
        alt="Kawa i herbata premium"
    ...
    >
      <div className="fade-up" style={{ maxWidth: 540 }}>
        ...
        >
          Starannie selekcjonowane kawy single origin i herbaty z najlepszych
          regionów świata. Każdy łyk to podróż.
        </p>
        <div
          style={{
            display: "flex",
      ...
      >
        {[
          ["240+", "Odmian kawy i herbaty"],
          ["18", "Krajów origin"],
          ["12k+", "Zadowolonych klientów"],
          ["4.9", "Średnia ocena"],
        ].map(([n, l]) => (
          <div key={n}>
            <p
      ...
      {BANNERS.map((b, i) => (
        <div
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = `0 20px 48px ${b.color}25`;
          }}
          onMouseLeave={(e) => {
        ...
        >
          ...
          <button
            style={{
              padding: "9px 20px",
              borderRadius: 20,
              border: `1.5px solid ${b.accent}60`,
              background: "transparent",
              color: b.accent,
              fontFamily: "'DM Sans',sans-serif",
              fontSize: 12,
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = `${b.accent}20`;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = "transparent";
            }}
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto" }}>
      ...
      >
        <div style={{ maxWidth: 520 }}>
          ...
          >
            Jesteśmy obsesyjnie zakochani
            <br />
            <em>w każdym ziarnku</em>
          </h2>
        </div>
        <p
          style={{
        ...
        >
          Od 2018 roku ręcznie selekcjonujemy najlepsze kawy i herbaty ze 18
          krajów świata. Każdy produkt przechodzi rygorystyczną ocenę naszych
          Q-Graderów.
        </p>
      </div>
      ...
      >
        {[
          {
            num: "01",
            title: "Bezpośrednie relacje",
            body: "Współpracujemy bezpośrednio z farmerami w Etiopii, Rwandzie, Japonii i Indiach. Płacimy minimum 30% powyżej ceny rynkowej — bo dobra kawa zaczyna się od uczciwego handlu.",
            color: "#C4882A",
          },
          {
            num: "02",
            title: "Świeże palenie",
            body: "Każda partia kawy jest palona na zamówienie w naszej mikro-palarni w Krakowie. Wysyłamy wyłącznie kawę paloną nie wcześniej niż 48h przed wysyłką.",
            color: accent,
          },
          {
            num: "03",
            title: "Certyfikowane źródła herbaty",
            body: "Nasze herbaty pochodzą z certyfikowanych ogrodów herbaciarskich. Współpracujemy z mistrzem herbaty z Kioto, który osobiście dobiera każdy zbiór.",
            color: "#8BBF8B",
          },
        ].map((p) => (
          <div
      ...
      >
        {[
          {
            q: "Najlepsza kawa jaką piłam poza Etiopią. Filiżanka Yirgacheffe to jak podróż.",
            name: "Zofia K.",
            loc: "Warszawa",
            stars: 5,
          },
          {
            q: "Matcha ceremonial grade zachwyciła mnie już od pierwszego przygotowania. Jedwabista i bez goryczy.",
            name: "Tomasz M.",
            loc: "Kraków",
            stars: 5,
          },
          {
            q: "Syrop lawendowy zupełnie zmienił moje poranne flat white. Zamawiałem już cztery razy.",
            name: "Ania W.",
            loc: "Gdańsk",
            stars: 5,
          },
  ...
  return (
    <section style={{ padding: "100px 48px", background: `${accent}08` }}>
      <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          Co tydzień wysyłamy nowości, przepisy i ekskluzywne oferty. Żadnego
          spamu — tylko dobra kawa i herbata.
        </p>
        ...
        >
          Zapisując się, akceptujesz naszą politykę prywatności. Wypisz się w
          dowolnym momencie.
        </p>
      </div>
    </section>
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto" }}>
      ...
      >
        ...
        <div>
          ...
          >
            Specialty Coffee & Premium Tea od 2018. Ręcznie selekcjonowane, z
            pasją dostarczane.
          </p>
            ...
            {["IG", "FB", "YT"].map((social) => (
              <span
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.color = "rgba(250,247,242,.5)";
                }}
              >
                {social}
              </span>
      ...
      >
        ...
        >
          © 2026 AromaBrew · Specialty Coffee & Tea
        </span>
        <span
          style={{
            fontFamily: "'DM Sans',sans-serif",
...
const TweaksPanel = ({
  ...
  tweaks: TweakState;
  setTweaks: React.Dispatch<React.SetStateAction<TweakState>>;
  visible: boolean;
}) => {
  if (!visible) return null;
  const upd = (k: keyof TweakState, v: any) => {
    const n = { ...tweaks, [k]: v };
    setTweaks(n);
  };
  ...
  return (
    <div
      style={{
        ...
        padding: "22px 24px",
        width: 280,
        boxShadow: "0 16px 48px rgba(28,18,9,.13)",
      }}
    >
      <p
        style={{
          ...
          {colors.map((c) => (
            <button
              ...
              style={{
                ...
                transform: tweaks.accentColor === c ? "scale(1.2)" : "scale(1)",
              }}
            />
          ))}
        </div>
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        <input
          value={tweaks.heroHeading}
          onChange={(e) => upd("heroHeading", e.target.value)}
          style={{
            width: "100%",
            padding: "8px 12px",
            border: "1.5px solid #E8DDD0",
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        >
          <div
            onClick={() => upd("showRatings", !tweaks.showRatings)}
            style={{
              width: 38,
              height: 22,
              borderRadius: 12,
              background: tweaks.showRatings ? tweaks.accentColor : "#E8DDD0",
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          {["2", "3", "4"].map((n) => (
            <button
              key={n}
              onClick={() => upd("gridCols", n)}
              style={{
                flex: 1,
                padding: "6px",
                borderRadius: 8,
                border: tweaks.gridCols === n ? "none" : "1.5px solid #E8DDD0",
                background:
                  tweaks.gridCols === n ? tweaks.accentColor : "transparent",
                color: tweaks.gridCols === n ? "#fff" : "#5C3D1E",
                fontFamily: "'DM Sans',sans-serif",
                fontSize: 12,
                cursor: "pointer",
              }}
    ...
    (catId: string) => {
      ...
      fetch(url)
        ...
        .then((rows: any[]) => {
          ...
          if (catId === "bestseller")
            mapped = mapped.filter((p) => p.rating >= 4.7);
          setDbProducts(mapped);
        })
        .catch((err) =>
          console.warn("Nie udało się pobrać produktów z backendu:", err),
        )
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          {filtered.length === 0 ? (
            ...
            >
              ...
              >
                Spróbuj innej frazy lub kategorii.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
              ...
              {Math.ceil(filtered.length / 6) > 1 && (
                ...
                >
                          ...
                          style={{
                            ...
                            border:
                              currentPage === i + 1
                                ...
                                : "1px solid #E8DDD0",
                            background:
                              currentPage === i + 1 ? accent : "transparent",
                            color: currentPage === i + 1 ? "#fff" : "#1C1209",
                            cursor: "pointer",
                            fontFamily: "'DM Sans',sans-serif",
                            fontSize: 13,
                            display: "flex",
                  ...
                  <button
                    onClick={() =>
                      setCurrentPage((p) =>
                        Math.min(Math.ceil(filtered.length / 6), p + 1),
                      )
                    }
                    ...
                    onMouseEnter={(e) => {
                      if (currentPage < Math.ceil(filtered.length / 6)) {
                        e.currentTarget.style.background = "#F2EBE0";
                      }
                    }}
                    onMouseLeave={(e) => {
